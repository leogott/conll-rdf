...
public class CoNLLRDFCommandLineTest {
     ...
     */
    @Test
    void silentTest() throws ParseException
    {
        Logger logger = Logger.getLogger("silentTest");
    ...
    @Test
    void helpTest() throws ParseException
    {
    }
    ...
    @Test
    public void readSparqlFileTest() throws IOException {
        ...
        selectQueryFromLiteral(readUrl(new URL("https://raw.githubusercontent.com/acoli-repo/conll-rdf/master/examples/sparql/select-sentence-strings.sparql")));
        readSparqlSelect("https://raw.githubusercontent.com/acoli-repo/conll-rdf/master/examples/sparql/select-sentence-strings.sparql");
    }
    ...
    public void preserveOrder()
    {
        ...
        Options optionsB = new Options()
            .addOption(Option.builder("rdf").hasArgs().optionalArg(true).desc("write formatted CoNLL-RDF to stdout (sorted by list of CoNLL COLS, if provided)").build())
            .addOption(Option.builder("conll").hasArgs().optionalArg(true).desc("write formatted CoNLL to stdout (only specified COLS)").build())
            ...
            .addOption("semantics", false, "write semantic graph to stdout")
            .addOption("sparqltsv", true, "write TSV generated from SPARQL statement to stdout.\nif with -grammar, then skip type assignments");
